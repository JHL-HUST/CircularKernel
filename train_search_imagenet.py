...
parser.add_argument('--tmp_data_dir', type=str, default='./dataset/', help='temp data dir')
parser.add_argument('--note', type=str, default='try', help='note for this run')
parser.add_argument('--operation', type=str, default='OPS', help='operation list in operations.py')
parser.add_argument('--gpu', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')

args = parser.parse_args()
if args.save=='checkpoints/':
    args.save = '{}search-{}-{}'.format(args.save, args.note, args.operation)
else:
  args.save = args.save
...
PRIMITIVES = eval("genotypes.%s" % args.operation)
...
def main():
    ...
    model = Network(args.init_channels, CLASSES, args.layers, criterion, PRIMITIVES)
    ...
    logging.info('runing time = %s', time.time() - start_time)
